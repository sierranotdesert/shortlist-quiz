...
(function () {
  ...
  var TRAITS = [
    ...
    { id: "spark", tier: 0, name: "Intellectual Spark", icon: "🧠", type: "slider",
      prompt: "Could you talk to him for six hours straight?", low: "brain's asleep", high: "six hours, easy" },
    { id: "geo", tier: 0, name: "Location Fit", icon: "📍", type: "cards",
      ...
      options: cards(["Same city, easy", "Logistics solved. Love that."], ["A doable distance", "Annoying, but survivable."],
        ["Different worlds, vibes only", "Cute now. Cancelled dates later."], ["He won't even discuss it", "Avoidance in a trench coat. 🚩"]) },
    { id: "conscious", tier: 0, name: "Tuned-In", icon: "🫶", type: "cards",
      prompt: "How does he treat waiters when nothing's in it for him?",
      options: cards(["A gem to everyone", "How he treats them = how he'll treat you."], ["Polite enough", "Fine. Keep watching."],
    ...
    { id: "drive", tier: 0, name: "Drive", icon: "🚀", type: "slider",
      prompt: "Is he chasing something he genuinely loves?", low: "pure coast", high: "absolutely on fire" },
    { id: "humble", tier: 0, name: "Humble", icon: "🙇", type: "swipe",
      prompt: "Can he tell a story where he isn't the hero?", yes: "He totally can", no: "Never not the hero" },
    { id: "optimism", tier: 0, name: "Optimism", icon: "☀️", type: "cards",
      prompt: "Something goes sideways — does he solve or sulk?",
      options: cards(["Solves it, calmly", "Green flag energy."], ["Vents, then solves", "Honestly relatable."],
        ["Spirals a little", "You'll be the emotional support human."], ["Makes it YOUR problem", "His bad day = your job. 🚩"]) },
    { id: "affable", tier: 0, name: "Affable", icon: "🥂", type: "hearts",
      prompt: "Would your closest friends actually like him?", label: "Tap how much your people would adore him" },
    { id: "attractive", tier: 0, name: "Attraction", icon: "🔥", type: "hearts", weight: 0.5,
      prompt: "On a normal, unstyled day — are you into him?", label: "Tap your honest, unstyled attraction (half weight)" },
    ...
    { id: "ambition", tier: 0, name: "Ambition", icon: "🎯", type: "slider",
      prompt: "Does he have a real vision for his life — not just vibes?", low: "just drifting", high: "knows exactly where he's headed" },

    // ---- Tier 1 · unlocks ~1 month ----
    { id: "competence", tier: 1, name: "Competence", icon: "✅", type: "slider",
      prompt: "Does he actually finish what he starts?", low: "all talk", high: "gets it done" },
    { id: "secure", tier: 1, name: "Secure", icon: "🧷", type: "meter",
      prompt: "How clingy does he get when you go off-grid for a few days?", low: "rock steady", high: "meltdown 🚩" },
    { id: "growth", tier: 1, name: "Growth", icon: "🌱", type: "swipe",
      prompt: "Can he take feedback without going full defense lawyer?", yes: "Takes it well", no: "Objection! Defensive." },
    { id: "generous", tier: 1, name: "Generous", icon: "🎁", type: "slider",
      prompt: "Does he give without keeping a scoreboard?", low: "keeps receipts", high: "gives freely" },
    { id: "mindbody", tier: 1, name: "Mind & Body", icon: "🧗", type: "slider",
      prompt: "Could he keep up on an adventure and handle his own mind?", low: "neither, really", high: "both, sorted" },
    { id: "resilience", tier: 1, name: "Resilience", icon: "🛡️", type: "cards",
      prompt: "Life roughed him up — wiser, or just bitter?",
    ...
    { id: "depth", tier: 1, name: "Sees Me", icon: "👁️", type: "slider",
      prompt: "Does he see the real you, not just the highlight reel?", low: "the surface", high: "the real me" },
    ...
    { id: "achievement", tier: 1, name: "Achievement", icon: "🏆", type: "cards",
      prompt: "Has he actually built something he's genuinely proud of?",
    ...
    { id: "closerel", tier: 2, name: "His People", icon: "👯", type: "swipe",
      prompt: "Does he have long-term friends who clearly love him?", yes: "Beloved by his people", no: "No real friends 🚩" },
    { id: "harmony", tier: 2, name: "Harmony", icon: "🕊️", type: "cards",
      ...
      options: cards(["Stayed a calm conversation", "Rare and beautiful."], ["Tense, but fair", "Normal. Fine."],
        ["He went ice cold", "Stonewalling is a tax you'll pay forever."], ["Full-blown war", "Home shouldn't be a battlefield. 🚩"]) },
    { id: "repair", tier: 2, name: "Repair", icon: "🤝", type: "swipe",
      prompt: "Can he say a real sorry — no 'but' attached?", yes: "A real, clean sorry", no: "'Sorry, but...' 🚩" },
